...
const styles = StyleSheet.create({
  ...
  accountActive: { flexDirection: 'row-reverse', alignItems: 'center', gap: space.md },
  ...
  totalHead: { flexDirection: 'row-reverse', alignItems: 'center', gap: space.sm },
  ...
  totalPills: { flexDirection: 'row-reverse', flexWrap: 'wrap', gap: 8, marginTop: 16 },
  ...
  payoutRow: { flexDirection: 'row-reverse', alignItems: 'center', gap: space.md, padding: space.lg },
  ...
  receiptBtn: { flexDirection: 'row-reverse', alignItems: 'center', gap: 4, paddingVertical: 4 },
